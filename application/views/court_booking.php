...
<div class="wrapper">
    <form action='<?php echo $page_url; ?>court_booking/check_booking' method='post' id="booking-form">
        <div class="container-fluid">
            <!--     Three dropdowns to let user to choose venue       -->
                    ...
                    <?php if ($_SESSION['usertype'] != 'coach'): ?>
                        <div class="row m-2 m-md-4" id="row-share">
                            <div class="col-xl-4">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="isShare2" name="is-share" class="custom-control-input"
                                           value="0"
                                           checked>
                        ...
                        <div class="row m-2 m-md-4 hidden" id="row-seat">
                            <div class="col-xl-4">
                                ...
                                <input type="text" class="form-control number" id="seat" name="seats"
