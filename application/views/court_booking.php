    ...
    <div class="container-fluid">
        <div class="row m-2 m-md-4">
            <div class="col-xl-4 mb-1">
                <label for="bs_college">Select College</label>
                <select class="form-control" name="bs_college" id="bs_college">
            ...
            <div class="col-xl-4 mb-1">
                <label for="bs_sport">Select Sport</label>
                <select class="form-control" name="bs_sport" id="bs_sport">
            ...
            <div class="col-xl-4 mb-1">
                <label for="bs_venue">Select Venue</label>
                <select class="form-control" name="bs_venue" id="bs_venue">
        ...
        <div class="row m-2 m-md-4">
            <div class="col-xl-4">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="isShare2" name="is-share" class="custom-control-input" value="0" checked>
        ...
        <div class="row m-2 m-md-4">
            <div class="col-xl-4">
                ...
                <textarea class="form-control" id="description" rows="3" placeholder="What you wanna say?"></textarea>
            </div>
        </div>
