        ...
        <div class="modal-dialog modal-confirm modaldia text-dark">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title col">Verification Failed!</h4>
                </div>
                <div class="modal-body">
                    <p class="text-center">Wrong username or answer!</p>
                </div>
                <div class="modal-footer row">
                    <form action='<?php echo $page_url; ?>login/forgot_main' method='post' id="confirm-form"></form>
