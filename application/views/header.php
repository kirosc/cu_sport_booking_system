                ...
                <?php else: ?>
                    ...
                    <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
                        ...
                        <?php if ($_SESSION['usertype'] == 'coach'): ?>
                            <?php if ($nav == 'course'): ?>
                                <li class='nav-item active'>
                                    <a class='nav-link' href='<?php echo $page_url ?>add_course' id='current'>Add Course
                                        <span class='sr-only'>(current)</span></a>
                                </li>
                            <?php else: ?>
                                <li class='nav-item'>
                        ...
                        <?php if ($_SESSION['usertype'] != 'coach'): ?>
                            <?php if ($nav == 'session_share'): ?>
                                <li class='nav-item active'>
                                    <a class='nav-link' href='<?php echo $page_url; ?>session_share' id='current'>Session
                                        Share <span class='sr-only'>(current)</span></a>
                                </li>
                            <?php else: ?>
                                <li class='nav-item'>
