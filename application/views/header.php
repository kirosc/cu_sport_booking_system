                ...
                <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] && isset($_SESSION['usertype']) && $_SESSION['usertype'] == 'admin'): ?>
                    <?php if ($nav == 'admin_session'): ?>
                      <li class='nav-item active'>
                        <a class='nav-link' href='<?php echo $page_url;?>admin/session' id='current'>Session Control <span class='sr-only'>(current)</span></a>
                      </li>
                    <?php else:?>
                      <li class='nav-item'>
                ...
                <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
                    <li class='nav-item dropdown'>
                          ...
                          <?php if ($_SESSION['usertype'] != 'admin'): ?>
                            <a class='dropdown-item' href='<?php echo $page_url;?>profile/<?php echo $_SESSION['username'];?>'>Profile</a>
