...
<!--                    <a href="--><?php //echo $page_url ?><!--profile/edit_profile" class="btn btn-info btn-md-block">Edit-->
<!--                        Profile</a>-->
<!--                --><?php //endif; ?>
<!--            </div>-->
<!--        </div>-->
...
<!--                    <h4 class="name">-->
<!--                        <span id="course-name">--><?php //echo $user['db']->first_name . " " . $user['db']->last_name; ?><!--'s Profile</span>-->
<!--                    </h4>-->
<!--                    <h4 class="group">-->
        ...
        <div class="row mt-4 justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="info-block mb-3 text-center"><img src="https://vignette.wikia.nocookie.net/uncyclopedia/images/0/03/200px-Super_Saiyan.jpg"
