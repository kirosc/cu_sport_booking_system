...
f: {
 init: {
     register: function () {
         var child, children = document.getElementsByClassName("material-select"), i
...
$(document).ready(function() {
    $('.psuedo_select').click(function() {
        var select = $(this)[0];
        $('.material-select.focused').each(function() {
            if(select != $('.psuedo_select', this)[0]) {
                $('.options', this).attr('style', '');
